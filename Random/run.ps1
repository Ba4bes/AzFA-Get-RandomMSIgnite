...
<Br> This site is running on an Azure Function App with PowerShell. Want to create your own? Click <a href = 'https://4bes.nl/MSIgnite'>here</a>
<Br><Br>
Barbara Forbes<br>
@Ba4bes<br>
<a href=https://4bes.nl>4bes.nl</a></font size=2>
"@)
